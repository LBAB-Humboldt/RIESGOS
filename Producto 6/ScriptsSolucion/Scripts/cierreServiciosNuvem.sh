...
#  SCRIPT DE DETENCION CONTROLADA DE LOS CONTENEDORES DOCKERIZADOS DE LA SOLUCION NUVEM CNCFLORA PORTAL
#***********************************************************************************************************************************************
#  OBJETIVO:  Permitir la detención controlada del nucleo (core) de Microservicios del Cluster de aplicaciones del Sistema NUVEM CNCFLORA y sus modulos:
#
...
#***********************************************************************************************************************************************
#  OBJETIVO:  Permitir la detención limpia de todos los contenedores Docker de la Solución NUVEM CNCFLORA
#***********************************************************************************************************************************************
#***********************************************************************************************************************************************
#***********************************************************************************************************************************************
DIA=`date +"%d/%m/%Y"`
...
echo "***********************************************************************************************************************************"
echo "  SCRIPT DE DETENCION CONTROLADA DE LOS CONTENEDORES DOCKERIZADOS DE LA SOLUCION NUVEM CNCFLORA PORTAL "
echo "  OBJETIVO:  Permitir la detención controlada del nucleo (core) de Microservicios del Cluster de aplicaciones del Sistema NUVEM CNCFLORA y sus modulos: "
